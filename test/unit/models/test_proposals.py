...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "tCa7rDMXs1KeqaqmcFoXxXMmwT9eq9r7oK", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://gov.trivechain.com/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "tCa7rDMXs1KeqaqmcFoXxXMmwT9eq9r7oK", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://gov.trivechain.com/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        payment_address="tCa7rDMXs1KeqaqmcFoXxXMmwT9eq9r7oK",
        payment_amount=13
    )
